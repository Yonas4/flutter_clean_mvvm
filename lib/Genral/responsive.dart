...
// remove All Padding of  the certain Widget
  ...
  // مساحة العرض سريعة الاستجابة - على سبيل المثال في SizedBox
  ...
  // مساحة الارتفاع سريعة الاستجابة - على سبيل المثال في SizedBox
  ...
  //
  // قياس حجم الخط بناءً على عامل القياس - يُستخدم لقياس حجم الخط
  double setFontSize({required double fontSize}) {
    ...
    //
    // إذا قمت بتقسيم ارتفاع الجهاز / ارتفاعه .. فسيقوم الخط بضبط نفسه داخل المربع
    //  ولكن في هذه الحالة، يعمل فقط حجم الخط.
  ...
  //يمكن استخدام هذا لضبط نصف القطر من جميع الجوانب وكذلك من جانب واحد فقط
...
extension ExtensionOnHeightWithOutToolbar on num {
  ...
  displayed below the toolbar.
    ...
    يحسب ارتفاع القطعة دون الأخذ بعين الاعتبار شريط الأدوات.
    شريط الأدوات هو المنطقة الموجودة أعلى الشاشة والتي تحتوي
     على شريط التطبيقات. تفيد هذه الوظيفة في حساب ارتفاع الأداة التي يجب عرضها أسفل شريط الأدوات.
  */
...
extension ExtensionOnHeightWithOutStatusbar on num {
  ...
  يحسب ارتفاع القطعة دون الأخذ بعين الاعتبار شريط الحالة.
  شريط الحالة هو المنطقة الموجودة أعلى الشاشة والتي تحتوي على الوقت والبطارية ومعلومات الحالة الأخرى.
  تفيد هذه الوظيفة في حساب ارتفاع الأداة التي يجب عرضها أسفل شريط الحالة.
